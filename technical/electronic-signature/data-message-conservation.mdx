...
La conservación de mensajes de datos es un procedimiento que se vale de la cadena de confianza de la infraestructura de seguridad extendida de Banxico para que un [PSC](/technical//electronic-signature/trust-service-providers) se comprometa a respaldar una fecha asociada a un mensaje de datos.
...
Ver [Certificados de NOM-151](/technical//electronic-signature/trust-service-providers#certificados-de-nom-151).
...
<Tip>En el caso de Plumaa ID, la conservación es garantizada por el [Testigo](/technical//information-system/components/witness) del sistema de información de Plumaa ID</Tip>
