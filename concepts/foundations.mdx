...
El algoritmo de firma es el método matemático que se utiliza para generar la firma electrónica. [El SAT](/basics/terminology#servicio-de-administracion-tributaria-sat) y otros [PSCs](/basics/terminology#proveedores-de-servicios-de-certificacion-psc) utiliza el [algoritmo RSA](/technical//electronic-signature/what-is-an-advanced-electronic-signature#criptosistema-rsa) con una longitud de llave de 2048 bits.
