...
La firma electrónica avanzada del SAT es una firma basada en el el [criptosistema RSA](/advanced/electronic-signature/what-is-an-electronic-signature#rsa) que cumple con los requisitos de la [Ley de Firma Electrónica Avanzada](https://www.diputados.gob.mx/LeyesBiblio/pdf/LFEA_200521.pdf) y que se utiliza para firmar documentos electrónicos.
