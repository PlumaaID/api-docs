...
<Tip>En el caso de Plumaa ID, la conservación es garantizada por el [Testigo](/advanced/technical/information-system/components/witness) del sistema de información de Plumaa ID</Tip>
